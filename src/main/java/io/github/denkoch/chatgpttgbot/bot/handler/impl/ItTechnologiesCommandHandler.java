...
@Component
public class ItTechnologiesCommandHandler extends RequestHandler {
    private final CallbackCommands command = CallbackCommands.IT_TECHNOLOGIES;

    private final TelegramService telegramService;
    private final KeyboardHelper keyboardHelper;

    public ItTechnologiesCommandHandler(TelegramService telegramService,
    ...
    public void handle(UserRequest userRequest) {
        ...
        message.setText(Texts.IT_TECHNOLOGIES_INFO_MESSAGE);
